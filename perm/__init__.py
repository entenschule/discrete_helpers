from a import true_except, is_natural, have

from perm.ex import ArgTypeError, SequenceError, CyclesError, DictError, OtherNotPermError, LengthTooSmallError
...
class Perm(object):
    ...
    from perm.properties import cycles, inverse, inversion_graph, inversion_set, order, parity

    from perm.methods import __getitem__, __eq__, __str__, __repr__, __hash__, __mul__, __pow__, \
